...
def connect():
    global mes  # Access the global mes variable
    # mes = some_value
    ...
    threading.Thread(target=listen_for_messages_from_server, args=(client, mes)).start()
...
####here
def listen_for_messages_from_server(client, mes):
...
# lock_file_path = "client_lock.txt"
...
# # Continue with the rest of your client.py script
# # ...
